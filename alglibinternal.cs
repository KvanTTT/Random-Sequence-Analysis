...
public partial class alglib
{
        ...
        *************************************************************************/
        ...
        X[0..N-1,0..N-1] are finite
          ...
          -- ALGLIB --
             Copyright 18.06.2010 by Bochkanov Sergey
        *************************************************************************/
        public static bool apservisfinitertrmatrix(double[,] x,
            int n,
            bool isupper)
        {
            bool result = new bool();
    ...
    public class ratinterpolation
    {
            ...
            ref double[] w)
        {
            ...
            ap.assert(n>0, "BuildRationalInterpolantWithoutPoles: N<=0!");
            ap.assert(d>=0 & d<=n, "BuildRationalInterpolantWithoutPoles: incorrect D!");
            ...
            tsort.tagsortfasti(ref x, ref perm, ref bufr1, ref bufi1, n);
